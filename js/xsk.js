...
aswitch.addEventListener("mouseover", function () {
  // Display the tooltip
  tooltip.style.display = "block";

  // If the device is mobile, set the tooltip to display none after 5 seconds
  if (isMobile) {
    setTimeout(function () {
...
aswitch.addEventListener("mouseout", function () {
  // If the device is not mobile (i.e., it's a desktop), hide the tooltip immediately when the mouse leaves the switch
  if (!isMobile) {
    tooltip.style.display = "none";
  }
});
